...
describe('Batching', () => {
  ...
  it('does not send requests right away', async () => {
    ...
    await dispatch(`https://webhook-dev.getastrolabe.com/v1/sdk/t`, {
      hello: 'world',
    })
  ...
  it('sends requests when the timeout expires', async () => {
    ...
    await dispatch(`https://webhook-dev.getastrolabe.com/v1/sdk/i`, {
      event: 'second',
    })
  ...
  describe('on unload', () => {
    it('flushes the batch', async () => {
      ...
      dispatch(`https://webhook-dev.getastrolabe.com/v1/sdk/t`, {
        hello: 'world',
      }).catch(console.error)
