...
describe('Segment.io', () => {
  ...
  describe('using a custom protocol', () => {
    it('should be able to send http requests', async () => {
      ...
      expect(url).toMatchInlineSnapshot(`"http://webhook-dev.getastrolabe.com/v1/sdk/p"`)
    })
  })
  ...
  describe('#page', () => {
    it('should enqueue section, name and properties', async () => {
      ...
      expect(url).toMatchInlineSnapshot(`"https://webhook-dev.getastrolabe.com/v1/sdk/p"`)
  ...
  describe('#identify', () => {
    it('should enqueue an id and traits', async () => {
      ...
      const [url, params] = spyMock.mock.calls[0]
      expect(url).toMatchInlineSnapshot(`"https://webhook-dev.getastrolabe.com/v1/sdk/i"`)
  ...
  describe('#track', () => {
    it('should enqueue an event and properties', async () => {
      ...
      const [url, params] = spyMock.mock.calls[0]
      expect(url).toMatchInlineSnapshot(`"https://webhook-dev.getastrolabe.com/v1/sdk/t"`)
  ...
  describe('#group', () => {
    it('should enqueue groupId and traits', async () => {
      ...
      const [url, params] = spyMock.mock.calls[0]
      expect(url).toMatchInlineSnapshot(`"https://webhook-dev.getastrolabe.com/v1/sdk/g"`)
  ...
  describe('#alias', () => {
    it('should enqueue .userId and .previousId', async () => {
      ...
      const [url, params] = spyMock.mock.calls[0]
      expect(url).toMatchInlineSnapshot(`"https://webhook-dev.getastrolabe.com/v1/sdk/a"`)
